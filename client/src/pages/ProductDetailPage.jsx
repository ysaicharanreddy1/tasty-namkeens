...
import { ArrowLeft, Store, ShieldCheck, Weight, ChevronRight, Loader2 } from 'lucide-react';
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-14 items-start">
            {/* Left: Product Image with Interactive Zoom */}
            <div className="space-y-3">
              <div
                ...
                className="relative aspect-square w-full bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden cursor-crosshair shadow-sm select-none"
              >
                <img
              ...
              <p className="text-center text-xs text-gray-400">
                Move your cursor over the image to inspect packaging, batch & nutritional details closely.
              </p>
            </div>
